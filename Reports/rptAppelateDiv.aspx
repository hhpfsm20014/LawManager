<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptAppelateDiv.aspx.cs" Inherits="Reports_rptAppelateDiv" EnableEventValidation="false" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Appellate Division Cases</title>
</head>
<body>
    <form id="form1" runat="server">
        <div>
            <h1><u>Appellate Division Cases:</u></h1>
