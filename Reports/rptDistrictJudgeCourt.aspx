<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptDistrictJudgeCourt.aspx.cs" Inherits="Reports_rptDistrictJudgeCourt" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>District Judge Court Cases</title>
</head>
<body>
    <form id="form1" runat="server">
        <div>
            <h1><u>District Judge Court Cases:</u></h1>
