<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptMetroPolSessionCourt.aspx.cs" Inherits="Reports_rptMetroPolSessionCourt" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Metropolitan Session Court Cases</title>
</head>
<body>
    <form id="form1" runat="server">
        <div>
            <h1><u>Metropolitan Session Court Cases:</u></h1>
