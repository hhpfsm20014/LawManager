<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptMetroMagistrate.aspx.cs" Inherits="Reports_rptMetroMagistrate" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Metropolitan Magistrate Cases</title>
</head>
<body>
    <form id="form1" runat="server">
        <div>
            <h1><u>Metropolitan Magistrate Cases:</u></h1>
