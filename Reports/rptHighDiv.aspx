<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptHighDiv.aspx.cs" Inherits="Reports_rptHighDiv" EnableEventValidation="false" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>High Court Division Cases</title>
</head>
<body>
    <form id="form1" runat="server">
        <div>
            <h1><u>High Court Division Cases:</u></h1>
