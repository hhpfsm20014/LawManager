<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptChiefMetMag.aspx.cs" Inherits="Reports_rptChiefMetMag" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Chief Metropolitan Magistrate Cases</title>
</head>
<body>
    <form id="form1" runat="server">
        <div>
            <h1><u>Chief Metropolitan Magistrate Cases:</u></h1>
