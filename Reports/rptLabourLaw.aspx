<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptLabourLaw.aspx.cs" Inherits="Reports_rptLabourLaw" EnableEventValidation="false" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Labour Law Court Cases</title>
</head>
<body>
    <form id="form1" runat="server">
        <div>
            <h1><u>Labour Law Court Cases:</u></h1>
